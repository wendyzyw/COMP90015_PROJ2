...
public class Font {
    ...
    private void buildBoldButton() {
        String imgPath = "/sample/icons/bold.png";
    ...
    private void buildItalicsButton() {
        String imgPath = "/sample/icons/italics.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
    ...
    private void buildUnderlineButton() {
        String imgPath = "/sample/icons/underline.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
    ...
    private void buildSuperScriptButton() {
        ...
        String imgPath = "/sample/icons/superscript.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
    ...
    private void buildSubScriptButton() {
        String imgPath = "/sample/icons/subscript.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
    ...
    private void buildIncreaseFontSizeButton() {
        String imgPath = "/sample/icons/increaseFont.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
    ...
    private void buildDecreaseFontSizeButton() {
        String imgPath = "/sample/icons/decreaseFont.png";
        Image image = new Image(this.getClass().getResourceAsStream(imgPath),
                16.0, 16.0, true, true);
        ImageView imageView = new ImageView(image);
